...
@section('container')
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ route('article.store') }}" class="row g-3" method="POST">
                <input type="hidden" name="project_id" value="{{ $project_id }}">
                @csrf
                <div class="col-6">
                    <label for="kode_artikel" class="form-label">Kode Artikel</label>
                    <small class="text-danger">*required</small>
                    <input class="form-control @error('kode_artikel') is-invalid @enderror" type="text" placeholder="Kode" name="kode_artikel" aria-label="default input example" value="{{ old('kode_artikel') }}" required>
                    @error('kode_artikel')
                ...
                <div class="col-12">
                    ...
                    <small class="text-danger">*required</small>
                    <input class="form-control @error('title') is-invalid @enderror" type="text" placeholder="Judul Artikel" name="title" aria-label="default input example" value="{{ old('title') }}" required>
                    @error('title')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div class="col-12">
                    ...
                    <small class="text-danger">*required</small>
                    <input class="form-control @error('publication') is-invalid @enderror" type="text" placeholder="Publication" name="publication" aria-label="default input example" value="{{ old('publication') }}" required>
                    @error('publication')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div class="col-6">
                    ...
                    <small class="text-danger">*required</small>
                    <input class="form-control @error('year') is-invalid @enderror" type="text" placeholder="YYYY" name="year" aria-label="default input example" id="year" value="{{ old('year') }}" required autocomplete="off">
                    @error('year')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div class="col-12">
                    ...
                    <small class="text-danger">*required</small>
                    <input class="form-control @error('authors') is-invalid @enderror" type="text" placeholder="Authors" name="authors" aria-label="default input example" value="{{ old('authors') }}" required>
                    @error('authors')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div class="col-6">
                    ...
                    <small class="text-danger">*required</small>
                    <input class="form-control @error('language') is-invalid @enderror" type="text" placeholder="Language" name="language" aria-label="default input example" value="{{ old('language') }}" required>
                    @error('language')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div class="col-12">
                    ...
                    <small class="text-danger">*required</small>
                    <input class="form-control @error('publisher') is-invalid @enderror" type="text" placeholder="Publisher" name="publisher" aria-label="default input example" value="{{ old('publisher') }}" required>
                    @error('publisher')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div class="col-4">
                    ...
                    <small class="text-danger">*required</small>
                    <input class="form-control @error('cited') is-invalid @enderror" type="number" placeholder="Cited" name="cited" aria-label="default input example" value="{{ old('cited') }}" required>
                    @error('cited')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div class="col-4">
                    ...
                    <small class="text-danger">*required</small>
                    <input class="form-control @error('cited_gs') is-invalid @enderror" type="number" placeholder="Cited" name="cited_gs" aria-label="default input example" value="{{ old('cited_gs') }}" required>
                    @error('cited_gs')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div class="col-4">
                    ...
                    <small class="text-danger">*required</small>
                    <input class="form-control @error('cited_other') is-invalid @enderror" type="text" placeholder="Cited" name="cited_other" aria-label="default input example" value="{{ old('cited_other') }}" required>
                    @error('cited_other')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div class="col-12">
                    ...
                    <small class="text-danger">*required</small>
                    <input class="form-control @error('keyword') is-invalid @enderror" type="text" placeholder="Keyword" name="keyword" aria-label="default input example" value="{{ old('keyword') }}" required>
                    @error('keyword')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div class="col-6">
                    ...
                    <small class="text-danger">*required</small>
                    <input class="form-control @error('edatabase') is-invalid @enderror" type="text" placeholder="Database 1" name="edatabase" aria-label="default input example" value="{{ old('edatabase') }}" required>
                    @error('edatabase')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
