...
<div class="container">
    ...
    <h1 class="text-center mb-5">Hubungan Antar {{$type}} & Keberpengaruhannya</h1>
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <select class="form-select" aria-label="Default select example" id="top-author" name="top-author">
                    <option selected>Jumlah {{$type}} Yang Dihighlight</option>
            ...
            <div class="col-md-4">
                <select class="form-select" aria-label="Default select example" id="outer-author" name="outer-author">
                    <option selected>Pilihan {{$type}} Tanpa Relasi</option>
    ...
    <div class="row">
        <div class="col-md-6">
        <h1 class="text-center mt-5">Graph {{$type}}</h1>
        ...
        <div class="col-md-6">
            <h1 class="text-center mt-5">Tabel Ranking {{$type}}</h1>
            <table class="table">
                <thead>
                    <tr>
                        <th>No</th>
